...
public class GalleryData {
    public Gallery addPhoto(int businessId){
        ...
        gallery.setPath("http://staging.eservia.com/image/media/201805/jAgUxCmshMJuFrFl.png");
        return  gallery;
    }

    public Gallery updatePhoto(int businessId){
        Gallery gallery = new Gallery();
        gallery.setPath("http://staging.eservia.com/image/media/201805/jAgUxCmshMJuFrFl1.png");
        return  gallery;
    }
}
