...
public class BookingData {
    public Booking addBookingAdmin(int TableIds, int DEpIds) {
        ...
        bookingAdmin.setBookingDateTime("2018-04-14T10:55:33.000");
        bookingAdmin.setBookingEndTime("2018-04-14T12:40:33.000");
    ...
    public Booking updateBookingAdmin (int TableIds, int DepIds, int id ) {
        ...
        updateBookingAdm.setBookingDateTime("2018-04-14T11:55:33.000");
        updateBookingAdm.setBookingEndTime("2018-04-14T14:40:33.000");
