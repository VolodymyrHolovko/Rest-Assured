...
String category = (faker.name().nameWithMiddle().toLowerCase()+faker.name().firstName()+rc).toLowerCase()+faker.name().firstName();
String sectorName = faker.name().username().toLowerCase()+faker.name().firstName().toLowerCase()+faker.name().firstName();
String name = faker.name().fullName().toLowerCase()+faker.name().firstName().toLowerCase()+faker.name().firstName();
String enName = faker.name().title().toLowerCase()+faker.name().firstName().toLowerCase()+faker.name().firstName();
String enNameUpdate = faker.name().title().toLowerCase()+faker.name().firstName().toLowerCase()+faker.name().firstName();
String alias = faker.name().firstName()+faker.name().firstName().toLowerCase()+faker.name().firstName();
String firstName = faker.name().firstName()+faker.name().firstName().toLowerCase()+faker.name().firstName();
String lastName = faker.name().username().toLowerCase()+faker.name().firstName().toLowerCase()+faker.name().firstName();
